	...
	public static void TreEmManager(String username) {
		...
		do {
			try {
				...
				System.out.println("5.Liệt kệ tất cả học sinh theo Giới Tính");
				System.out.println("6.Liệt kê tất cả học sinh đã duyệt đăng ký vào lớp");
				System.out.println(
						"7.Hiển thị top 3 môn học có số lượng học sinh học nhiều nhất trong tháng x/2020 (X nhập vào từ bàn phím)");
